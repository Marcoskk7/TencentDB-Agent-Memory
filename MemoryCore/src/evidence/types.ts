...
export interface Evaluation { evaluation_id: string; run_id: string; idempotency_key?: string; access_id?: string; comparison_verified?: boolean; control_run_id?: string; baseline_commit?: string; environment_fingerprint?: string; passed?: boolean; gain?: number; contamination?: boolean; independent_causal_evidence?: boolean; metrics?: Record<string, number>; created_at: string; }
